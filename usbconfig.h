 ...
 *
 * *** IMPORTANT NOTE FROM RAPHNET ***
 *
 * This file use one of my Vendor ID/Product ID pairs. Please do not re-use
 * for your own projects if you plan to distribute your work. You may, however,
